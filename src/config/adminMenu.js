...
export const ADMIN_MENU_DEFS = [
  ...
  { name: 'posts', path: '/posts', icon: 'PictureFilled', defaultTitle: '帖子管理' },
  { name: 'interactions', path: '/interactions', icon: 'Connection', defaultTitle: '互动关系' },
  { name: 'emotion-logs', path: '/emotion-logs', icon: 'Sunny', defaultTitle: '情绪日志' },
